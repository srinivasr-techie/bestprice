...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/bestpricestorefront/electronics/en",
						"https://electronics.local:9002/bestpricestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/bestpricestorefront/electronics/en",
						"https://electronics.local:9002/bestpricestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/bestpricestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/bestpricestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/bestpricestorefront/electronics/en",
						"https://electronics.local:9002/bestpricestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/bestpricestorefront",
						"https://electronics.local:9002/bestpricestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/bestpricestorefront",
						"https://electronics.local:9002/bestpricestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/bestpricestorefront/electronics/en",
						"https://electronics.local:9002/bestpricestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
