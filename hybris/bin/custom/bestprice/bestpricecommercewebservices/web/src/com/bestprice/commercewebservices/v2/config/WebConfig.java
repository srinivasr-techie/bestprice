 ...
 */
package com.bestprice.commercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.bestprice.commercewebservices.constants.YcommercewebservicesConstants;
import com.bestprice.commercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "bestpricecommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "bestpricecommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "bestpricecommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "bestpricecommercewebservices.v2.description";
	private static final String TITLE = "bestpricecommercewebservices.v2.title";
	private static final String VERSION = "bestpricecommercewebservices.v2.version";
	private static final String LICENSE = "bestpricecommercewebservices.v2.license";
	private static final String LICENSE_URL = "bestpricecommercewebservices.v2.license.url";
