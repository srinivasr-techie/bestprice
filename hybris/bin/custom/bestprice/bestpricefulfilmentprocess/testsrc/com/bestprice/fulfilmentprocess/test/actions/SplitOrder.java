 ...
 */
package com.bestprice.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(BestpriceFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BestpriceFulfilmentProcessConstants.PARENT_PROCESS);
