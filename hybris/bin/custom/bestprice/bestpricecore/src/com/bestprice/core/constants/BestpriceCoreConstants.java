 ...
 */
package com.bestprice.core.constants;

/**
 * Global class for all BestpriceCore constants. You can add global constants for your extension into this class.
 */
public final class BestpriceCoreConstants extends GeneratedBestpriceCoreConstants
{
	public static final String EXTENSIONNAME = "bestpricecore";


	private BestpriceCoreConstants()
	{
		//empty
	}
