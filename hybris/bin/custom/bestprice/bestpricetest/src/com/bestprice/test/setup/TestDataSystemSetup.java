 ...
 */
package com.bestprice.test.setup;
...
import com.bestprice.test.constants.BestpriceTestConstants;
import com.bestprice.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BestpriceTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/bestpricetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/bestpricetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/bestpricetest/import/cstickets.impex");
			...
			importImpexFile(context, "/bestpricetest/import/csquotes.impex");
		}
	}
}
